...
Page({
    ...
    loadData: function(t) {
        ...
        if (t.cat_id) for (var s in e) {
            var o = !1;
            e[s].stc_id == t.cat_id && (e[s].checked = !0, e[s].list.length > 0 && (i = "height-bar"));
    ...
    reloadGoodsList: function() {
        ...
        a.request({
            url: newapi.goods.goods_list,
            data: {
                stc_id: s,
                page: o,
                sort: e.data.sort,
                type: e.data.sort_type,
            },
            success: function(t) {
                console.log(t);
                0 == t.code && (0 == t.data.length && (i = !0), e.setData({
                    page: o + 1
                }), e.setData({
                    goods_list: t.data,
                })), e.setData({
                    show_no_data_tip: 0 == e.data.length
                });
            },
            complete: function() {}
        });
