...
Page({
    data: {
        ...
        orders:[
            {
                user_img:"/images/total/home_bnt_banner@2x.png",
                user_name:"凯鹰厨卫",
                goods_img:"/images/total/home_bnt_banner@2x.png",
                goods_name:"暖眠北欧三人沙发橡木家具暖眠北欧三人沙发橡木家具",
                goods_spec:"白橡木 1800mm*2000mm",
                goods_price:"5999.00",
                goods_num:1,
                goods_status:0
            },
             {
                user_img:"/images/total/home_bnt_banner@2x.png",
                user_name:"暖眠北欧三人沙发橡木家具暖眠北欧三人沙发橡木家具",
                goods_img:"/images/total/home_bnt_banner@2x.png",
                goods_name:"凯鹰厨卫",
                goods_spec:"白橡木 1800mm*2000mm",
                goods_price:"5999.00",
    ...
    toggleTab:function (e){
        var num = parseInt(e.currentTarget.dataset.name)+1;
        this.setData({
    ...
    onShow: function() {
        e.pageOnShow(this);
        var length = this.data.orders.length;
        this.setData({
            height:length*420
        })
    }
