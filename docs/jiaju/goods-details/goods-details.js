var t = require("../../../wechat/api.js"), newapi = require("../../../wechat/newapi.js"), a = require("../../../wechat/utils.js"), o = getApp(), i = require("../../../wechat/wxParse/wxParse.js"), r = 1, e = !1, s = !0, d = 0;
        ...
        o.request({
            ...
            success: function(t) {
                if (0 == t.code) {
                    ...
                    a.setData({
                        info: t.data,
                        goods_image: t.data.goods_images,
                        attr_group_list: t.data.spec_value
                    }), a.selectDefaultAttr();
                }
