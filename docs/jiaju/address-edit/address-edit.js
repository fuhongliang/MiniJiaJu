var t = require("../../api.js"), e = require("../../area-picker/area-picker.js"), i = getApp();
...
Page({
    ...
    saveAddress: function() {
        var e = this, a = /^([0-9]{6,12})$/, d = /^(\d{3,4}-\d{6,9})$/, s = /^\+?\d[\d -]{8,12}\d/;
        if (console.log(d.test(e.data.mobile)), !a.test(e.data.mobile) && !d.test(e.data.mobile) && !s.test(e.data.mobile)) return wx.showToast({
            title: "联系电话格式不正确",
