  ...
  otherMobile: function (t) {
    ...
    getOffline: function(t) {
        ...
        if (1 == t.currentTarget.dataset.index) this.setData({
            ...
            var s = a.data.is_area_city_id, o = a.data.address ? a.data.address.city_id : null;
            o && s && function(t, a) {
    ...
    check:function(h){
      var _this = this;
      if (!_this.data.other_mobile || void 0 == _this.data.other_mobile) return void a.showToast({
        title: "请填写会员手机号",
        image: "/images/icon-warning.png"
      });
    ...
    orderSubmit: function(t) {
      ...
      // if (!a.data.other_mobile || void 0 == a.data.other_mobile) return void a.showToast({
      //   title: "请填写会员手机号",
      //   image: "/images/icon-warning.png"
      // });
      // if (!/^\+?\d[\d -]{8,12}\d/.test(a.data.other_mobile)) return void wx.showModal({
      //   title: "提示",
      //   content: "会员手机号格式不正确",
      //   showCancel: !1
      // });
        ...
        if (1 == o.is_form && a.data.goods_list && a.data.goods_list.length) {
            var n = o.list;
            for (var d in n) if ("date" == n[d].type && (n[d].default = n[d].default ? n[d].default : a.data.time), 
        ...
        1 == a.data.integral_radio ? i.use_integral = 1 : i.use_integral = 2, a.data.goods_list && a.data.goods_list.length || !a.data.mch_list || 1 != a.data.mch_list.length || (i.content = a.data.mch_list[0].content ? a.data.mch_list[0].content : ""), 
          i.payment = a.data.payment, i.formId = t.detail.formId, i.other_mobile = a.data.other_mobile, a.order_submit(i, "s");
    },
    onReady: function() {},
    onShow: function(t) {
        if (!getApp().onShowData || !getApp().onShowData.scene || 1034 != getApp().onShowData.scene) if (o) o = !1; else {
            ...
            var i = this, s = wx.getStorageSync("picker_address");
            if (s) {
                var n = i.data.is_area_city_id, d = {};
                n && (!function(t, a) {
                    for (var e = 0; e < t.length; e++) if (a == t[e]) return !1;
                    return !0;
                }(n, s.city_id) ? d.is_area = 0 : d.is_area = 1), d.address = s, d.name = s.name, 
                d.mobile = s.mobile, wx.removeStorageSync("picker_address"), i.setData(d), i.getInputData();
            }
        ...
        s.goods_info && (n.goods_info = s.goods_info), a.request({
            ...
            success: function(t) {
                if (wx.hideLoading(), 0 == t.code) {
                    ...
                    a.coupon_list = i, a.shop_list = n, a.send_type = t.data.send_type, a.level = t.data.level, 
    ...
    getPrice: function() {
        var t = this, a = t.data.total_price, e = t.data.express_price, i = t.data.picker_coupon, s = t.data.integral, o = t.data.integral_radio, n = t.data.level, d = t.data.offline;
        if (t.data.goods_list && t.data.goods_list.length > 0 && (i && (a -= i.sub_price), 
        s && 1 == o && (a -= parseFloat(s.forehead)), n && (a = a * n.discount / 10), a <= .01 && (a = .01), 
        0 == d && (a += e)), t.data.mch_list && t.data.mch_list.length) for (var r in t.data.mch_list) a += t.data.mch_list[r].total_price + t.data.mch_list[r].express_price;
        t.setData({
