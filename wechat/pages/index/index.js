var t = require("../../api.js"), newapi = require("../../newapi"), a = getApp(),host = require("../../config.js"), e = 0, o = 0, i = !0, r = 1, s = "", n = !1;
Page({
    data: {
    ...
    onLoad: function(t) {
        var that = this;
        a.pageOnLoad(this), this.loadData(t), this.test(), this.test2();
        var e = 0, o = t.user_id, i = decodeURIComponent(t.scene);
        void 0 != o ? e = o : void 0 != i && (e = i), a.loginBindParent({
            parent_id: e
        });
        if (wx.getStorageSync("current_district")) {
            that.setData({district:wx.getStorageSync("current_district")});
        } else {
            wx.setStorageSync("current_district", that.data.district);
        }
        if(parseInt(that.data.new_user) == 1){
            that.setData({
                evaluate_show:true
            })
        }
    ...
    onUnload: function() {
        a.pageOnUnload(this), this.setData({
            play: -1
        }), clearInterval(r), clearInterval(1), clearInterval(o), console.log("unload");
    },
    showNotice: function() {
        this.setData({
            show_notice: !0
