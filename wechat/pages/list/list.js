var t = require("../../api.js"), a = getApp(), e = !1, i = !1,host = require('../../config.js');
...
Page({
    ...
    reloadGoodsList: function() {
        var e = this;
        var district = wx.getStorageSync("current_district");
        i = !1, e.setData({
            page: 1,
            goods_list: [],
            show_no_data_tip: !1
    ...
    toggleState:function(e){
        var num = 98 - (e.detail.scrollTop);
        if(e.detail.scrollTop>0&&e.detail.scrollTop<98){
            this.setData({
                marginTop:num
            })
        }else if(e.detail.scrollTop>98){
            this.setData({
                marginTop:0
            })
    ...
    toggleStore:function(e){
       ...
       }else if(e.currentTarget.dataset.sort == 1){
           this.setData({
               store_toggle:1
           })
           this.loadStoreList(2);
       }else if(e.currentTarget.dataset.sort == 2){
           this.setData({
               store_toggle:2
           })
           this.loadStoreList(3);
       }
    },
    toggleClassify:function(s){
      if(s.currentTarget.dataset.classify == 0||s.detail.current == 0){
          this.setData({
              classify:0
          })
      }else if(s.currentTarget.dataset.classify == 1||s.detail.current == 1){
          this.setData({
              classify:1
          })
      }  
