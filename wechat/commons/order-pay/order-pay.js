var e = require("../../api.js"),host = require('../../config.js'), t = getApp(), a = {
    init: function(a, o) {
        var i = this;
        i.page = a, t = o, i.page.orderPay = function(a) {
                ...
                t.request({
                    ...
                    success: function(e) {
                        0 == e.code && wx.requestPayment({
                            ...
                            title: e.msg,
                            image: host.hostUrl+"/icon-warning.png"
                        });
                    }
                });
            }
            ...
            1 == d.length ? (wx.showLoading({
                ...
                confirmText: "微信支付",
                success: function(e) {
                    console.log(n.order_id, p, u,o);
                    console.log(n.order_id, p, u);
                                ...
                                t.request({
                                    ...
                                    success: function(e) {
                                        ...
                                        setTimeout(function() {
                                            ...
                                            url: "/storage/pt/group/detail?oid=" + n
            ...
            var n = e.order.submit, d = e.order.pay_data, c = "/order/order/order?status=6";
            if ("pt" == s ? (n = e.group.submit, d = e.group.pay_data, c = "/storage/pt/order/order") : "ms" == s && (n = e.miaosha.submit, 
