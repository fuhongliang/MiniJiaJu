var api = require("../../api.js"),
    utils = require("../../utils.js"),host = require('../../config.js'),
    app = getApp();
Page({
    data: {
        tab: 1,
    ...
    onLoad: function(t) {
        ...
        a.setData({
            ...
            a.onScroll()
        }, 40),this.recommendGoods(), this.getShopData()
    },
        ...
        t && a.setData({
            ...
            success: function(t) {
                1 != t.code ? 0 == t.code && (a.setData({
                    ...
                    recommendList: t.data.goods_list,
                    new_list: t.data.new_list,
                    follow:t.data.is_favorite
    ...
    showStoreMsg:function(){
        var msg = this.data.isShowMsg;
        msg==true?this.setData({isShowMsg:false}):this.setData({isShowMsg:true});
    },
    toggleCases:function(){
        var that = this;
        app.request({
            url:api.topic.shop_cases,
            data: {
    ...
    toggleFollow:function(){
        var that = this;
        var id = wx.getStorageSync("shop_data_mch_id_4").shop.id;
        console.log(id);
        if(this.data.follow ==0){
            console.log(api.user.is_follow);
            console.log("关注");
            app.request({
                url:api.user.is_follow,
                method:"post",
                data:{
                    mch_id:id
                },
