var e, t = require("./utils/utils.js"), n = require("./commons/order-pay/order-pay.js"),link = require('./api.js');

App({
    is_on_launch: !0,
    onShowData: null,
    onLaunch: function() {
        this.setApi(), e = this.api, this.getNavigationBarColor(), console.log(wx.getSystemInfoSync()), console.log(e),
    ...
    getStoreData: function() {
        this.request({
            ...
            success: function(e) {
                ...
                wx.setStorageSync("share_setting", e.data.share_setting), getApp().permission_list = e.data.permission_list);
            },
            complete: function() {}
        });
    },
    ...
    setApi: function() {
        ...
        this.api = e(this.api);
        var n = this.api.default.index, a = n.substr(0, n.indexOf("/index.php"));
        this.webRoot = a;
    },
    webRoot: null,
    ...
    openWxapp: function(e) {
        if (console.log("--openWxapp---"), e.currentTarget.dataset.url) {
            ...
            (t = function(e) {
                var t = /([^&=]+)=([\w\W]*?)(&|$|#)/g, n = /^[^\?]+\?([\w\W]+)$/.exec(e), a = {};
                if (n && n[1]) for (var o, i = n[1]; null != (o = t.exec(i)); ) a[o[1]] = o[2];
                return a;
