...
module.exports = function(a) {
    ...
    let app_secret = this.siteInfo.app_secret;
    let access_sign = md5(md5(nonce_str+app_secret)+access_time);
    var t = wx.getStorageSync("access_token");
    t && (a.data.access_token = t), a.data._uniacid = this.siteInfo.uniacid,
        a.data._acid = this.siteInfo.acid,a.data.app_key = this.siteInfo.app_key,
        a.data.store_id = this.siteInfo.store_id, a.data.openid = wx.getStorageSync('access_openid'),
        a.data.session_key = wx.getStorageSync('access_session_key'),
        a.data.nonce_str = nonce_str,a.data.access_time = access_time,
        a.data.access_sign = access_sign;
    wx.request({
        url: a.url,
        header: a.header || {
